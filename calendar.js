...
var cal = {
   //[{"summary":null,"calendarId":null,"eventId":null,"date":null,"start_time":null,"endtime":null,"description":null}],
  // (A) PROPERTIES
  mName : ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], // Month Names
  data : null, // Events for the selected period
  edata: [{"summary":null,"calendarId":null,"eventId":null,"date":null,"start_time":null,"endtime":null,"description":null}],
  ...
  show : function (el) {
    ...
    tForm += "<input id='evt-summary' name='summary' type='text' class='inc' placeholder='summary'/><br/><label>Start Time: </label>&nbsp;"
    tForm += "<input id='evt-stime' name='start_time' type='time' class='tic' /><br /><label>End Time:</label>&nbsp;&nbsp;&nbsp;";
    tForm += "<input id='evt-etime' name='end_time' type='time' class='tic'  /><br />";
    tForm += "<textarea id='evt-details' name='description' class='inc' placeholder='description' required >" + (cal.data[cal.sDay] ? cal.data[cal.sDay] : "") + "</textarea>";
